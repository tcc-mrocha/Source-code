...
node_nome = "node-cozinha" -- nomde do dispositivo
...
top_base = "tccmrocha/cozinha" -- topico base do dispositivo
...
mqtt_cliente:on(
    ...
    function(client, topic, data)
        ...
        if topic == "tccmrocha/all/pergunta" and data == "ping" then
            ...
            mqtt_cliente:publish("tccmrocha/all/resposta/cozinha", wifi.sta.getip().." - Online", 0, 0, function() 
